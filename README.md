...
|---------|-------------|--------------|
| | 🛡️ Home SOC Lab with Wazuh | Designed and deployed a cloud based Security Operations Center using Wazuh to monitor Windows and Linux endpoints, centralize telemetry, perform threat hunting, validate File Integrity Monitoring, investigate Microsoft Defender EICAR detections, and map activity to MITRE ATT&CK. | Wazuh, SIEM, XDR, Ubuntu Server, Windows 11, Linux, VirtualBox, Google Cloud Platform, Syscheck (FIM), Microsoft Defender, MITRE ATT&CK | | Wazuh, SIEM, XDR, Ubuntu Server, Windows 11, Linux, VirtualBox, Google Cloud Platform, Syscheck (FIM), Microsoft Defender, MITRE ATT&CK |
